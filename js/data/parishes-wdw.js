...
export const parishesData = [
  ...
  },
  {
    ...
    phone: "(407) 420-9993",
    website: "https://www.incarnationorlando.org",
    isFlagship: false,
  ...
  },
  {
    ...
    phone: "(407) 351-0133",
    website: "https://www.stnicholasorlando.org",
    isFlagship: false,
  ...
  },
  {
    ...
    phone: "(407) 363-7405",
    website: "https://www.stjudeorlando.org",
    isFlagship: false,
  ...
  },
  {
    ...
    address: "15551 N. Boggy Ford Rd, Clermont, FL 34714",
    distance: "10-15 minutes from Flamingo Crossings & Western WDW resorts",
    phone: "(352) 515-9297",
    website: "https://www.stfaustina.org",
    isFlagship: false,
    description: "Dedicated to the Apostle of Divine Mercy, St. Faustina is located right off US-27, ideal for families staying in vacation rental villas and Western WDW hotels.",
    ...
    features: [
      ...
      "Spacious modern church with warm community atmosphere",
